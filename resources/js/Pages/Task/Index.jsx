...
export default function index({ auth, tasks, queryParameters = null}) {
    ...
    const searchFieldChanged = (name, value) => {
        ...
        router.get(route('task.index', queryParameters))
    }
                                ...
                                <tbody>
                                    {tasks.data.map((task) => (
                                        <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700" key={task.id}>
                                            ...
                                            <td className="px-3 py-2"><img src={ task.image_path } alt=""  style={{width:60}}/></td>
